 ...
 * @author Jasmine
 */
public class PipeDreamsV6 extends Canvas implements Runnable {
   ...
   // public final int scale = 2;
    ...
    private void render(){
        ...
        liquidTiles.getBoard(tiles.getTileBoard());
        ...
        tiles.updateLiquidXYCoord(liquidTiles.getXCoords(), liquidTiles.getYCoords());
