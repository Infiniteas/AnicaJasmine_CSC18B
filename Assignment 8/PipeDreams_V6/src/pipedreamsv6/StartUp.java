...
public class StartUp extends JFrame {
       ...
       playerQueries = new PlayerInfoQueries();
        ...
        loginPlayerPanel.newGameButton.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                //saves the username string
                loadInfo.setInfo(loginPlayerPanel.usernameTextField.getText());
                
                if(loadInfo.checkFileExistence()){
                    
                    //checks saved files for matched username
                    loadInfo.openFile();
                    loadInfo.readRecords();
                    loadInfo.closeFile();
                    
                    //if there exists a username with the right password
                    //game will continue
        ...
        newPlayerPanel.doneButton.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                //TO DO: Save Info and start new game
                 ...
                 playerQueries.addPlayer(newPlayerPanel.firstNameTextField.getText(), 
                    newPlayerPanel.lastNameTextField.getText(), newPlayerPanel.emailTextField.getText(),
                    newPlayerPanel.usernameTextField.getText(), newPlayerPanel.passwordTextField.getText());
                
                //saves the info in a serializable class
                info.setFirstName(newPlayerPanel.firstNameTextField.getText());
                info.setLastName(newPlayerPanel.lastNameTextField.getText());
    ...
    //a pop up dialouge box appears to show there is no match between username
    //and password
