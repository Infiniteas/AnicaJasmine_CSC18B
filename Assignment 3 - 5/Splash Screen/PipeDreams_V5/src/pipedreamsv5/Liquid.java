...
public class Liquid {
            ...
            switch(tileBoard[row][col]){
                    ...
                    case 3:     if (flow == Direction.LEFT){
                                    ...
                                    if (yUp != 0){
                                        ...
                                        if(count % condition*2 == 0 && xLeft != 5){
                    ...
                    case 4:     if (flow == Direction.LEFT){
                                    ...
                                    if (yUp != 0) {
                                        ...
                                        //grabs and draws tile image
                                        liquidTile4 = ss.grabImage(5, 1, xLeft, yUp);
                                        g.drawImage(liquidTile4, drawX, drawY, null);
                                        
                                        
                                        if (count % condition*2 == 0 && xLeft != 70) {
                                    ...
                                    if (xRight != 100) {
                                        ...
                                        //grabs and draws tile image
                                        liquidTile4 = ss.grabImage(5, 1, xRight, yUp);
                                        g.drawImage(liquidTile4, drawX, drawY, null);
                    ...
                    case 6:     if (flow == Direction.RIGHT){
                                   ...
                                   if (yUp != 0){
                                        ...
                                        if (count % condition*2 == 0 && xRight != 40) {
  ...
  private void getNextTileRowCol(){
    ...
    private boolean validateNextRowColIndex(int x){
        ...
        System.out.println("row - 1:  " + (row - 1));
        switch(x){
            case 1:     if (flow == Direction.LEFT && (col - 1 < 0)) {
                            return false;
                        } else if (flow == Direction.RIGHT && (col + 1 > 5)) {
                            return false;
                        }
                break;
            case 2:     if (flow == Direction.DOWN && (row + 1 > 5)) {
                            return false;
                        } else if (flow == Direction.UP && (row - 1 < 0)) {
                            return false;
                        }
                break;
            case 3:     if (flow == Direction.DOWN && (col + 1 > 5)) {
                            return false;
                        } else if (flow == Direction.LEFT && (row - 1 < 0)) {
                            return false;
                        }
                break;
            case 4:     if (flow == Direction.UP && (col + 1 > 5)) {
                            return false;
                        } else if (flow == Direction.LEFT && (row + 1 > 5)) {
                            return false;
                        }
                break;
            case 5:     if (flow == Direction.RIGHT && (row + 1 > 5)) {
                            return false;
                        } else if (flow == Direction.UP && (col - 1 < 0)) {
                            return false;
                        }
                break;
            case 6:     if (flow == Direction.RIGHT && (row - 1 < 0)) {
                            return false;
                        } else if (flow == Direction.DOWN && (col + 1 > 5)) {
                            return false;
                        }
                break;
        }
     ...
     */
    private boolean validateNextTile(){
    ...
    private void checkEndTilePosition(){
        //TODO:check end tile position
    }
